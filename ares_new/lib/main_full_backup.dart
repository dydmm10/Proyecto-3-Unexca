...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('DEBUG: MyApp.build() iniciado');
    try {
      final app = MaterialApp(
      ...
      print('DEBUG: MaterialApp creado exitosamente');
      return app;
    } catch (e) {
      print('DEBUG: Error en MyApp.build(): $e');
      print('DEBUG: Stack trace: ${StackTrace.current}');
      rethrow;
    }
  }
...
class _EquipmentListPageState extends State<EquipmentListPage> {
  ...
  Future<void> _deleteEquipment(int codEquipos, String marca, String modelo, String serial) async {
    ...
    final result = await _authService.deleteEquipmentAndUpdate(codEquipos);
    ...
    if (result.success) {
      ...
      // Forzar reconstrucción adicional para asegurar actualización visual
      Future.microtask(() {
        if (mounted) {
          setState(() {
            _futureEquipments = _authService.fetchEquipments();
...
class _CreateWorkOrderPageState extends State<CreateWorkOrderPage> {
  ...
  void initState() {
    ...
    // Resetear variables para evitar valores de instancias anteriores
    _categoria = 0;
    _codCliente = 0;
    _tipo = 'Reparación';
    _prioridad = 'BAJA';
      ...
      if (mounted) {
        ...
        setState(() {
          ...
          if (categorias.isNotEmpty) {
            ...
            _categoria = categorias.first['cod_categoria'] ?? 0;
                                ...
                                : DropdownButton<int>(
                                    ...
                                    items: _categorias.map((categoria) {
                                      ...
                                      return DropdownMenuItem<int>(
                                        ...
                                        value: categoria['cod_categoria'] as int,
